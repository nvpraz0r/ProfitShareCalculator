...
class Utils:
    ...
    def get_validation_method(self, prompt, prompt_data_type):    
        ...
        match prompt_data_type:
            case 1:
                # float
                return self.input_validation_float(prompt)
            case 2:
                # string
                return self.input_validation_string(prompt)
            case _:
                print("Error occurred somewhere during the validation process.")


    # check if input is a valid float
    def input_validation_float(self, prompt):
        """
    ...
    def input_validation_string(self, prompt):
        """
